...
public class CapyEntity extends TamableAnimal {
    ...
    public static boolean canSpawn(EntityType<CapyEntity> entityType, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
        return Animal.checkMobSpawnRules(entityType, level, spawnType, pos, random) ; // && level.getLevelData().isRaining(); Spawn en lluvia para futuro
    }
